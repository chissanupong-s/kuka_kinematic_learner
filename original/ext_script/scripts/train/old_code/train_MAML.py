...
#
# For IK mode, you can warm-start from your single-task IK checkpoint.
# For FK mode, you can warm-start from your single-task FK checkpoint.
                ...
                torch.save(
                    {
                        ...
                        "mode": mode,
                        "hidden_dim": model.fc_in.out_features if mode == "ik" else model.fc_in.out_features,
...
def main():
    ...
    # ---- create meta model (optionally warm-start from single-task checkpoint) ----
    if args.mode == "fk":
        # FK meta: ResidualMLP
